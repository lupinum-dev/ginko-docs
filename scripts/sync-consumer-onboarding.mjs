...
const source = await readFile(
  resolve(root, "docs/content/en/1.docs/1.getting-started/2.installation.md"),
  "utf8",
);
const [start, finish] = bounds(source);
const block = source.slice(start, finish);
for (const file of ["README.md", "layer/README.md"]) {
  ...
  if (process.argv.includes("--write"))
    ...
    throw new Error(`${file} onboarding is stale. Run pnpm docs:onboarding.`);
}
