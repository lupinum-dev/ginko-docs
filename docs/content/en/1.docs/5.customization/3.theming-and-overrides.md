...
Readers who toggle the header theme switch choose an explicit light or dark preference. Clear the stored color-mode preference in the browser to follow the operating system again.
