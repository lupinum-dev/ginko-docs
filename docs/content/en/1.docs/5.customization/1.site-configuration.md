...
`site.url` is the runtime origin for canonical links and page actions. Use the same production origin in app config, Nuxt Site Config, and `i18n.baseUrl`; [SEO and social cards]($docs/features/seo-and-social-cards) shows the complete wiring.
