...
| ------------------ | ---------------------- | ----------- | ------------------------------------------------- |
| `theme.preset`     | `'default' \| 'nuxt'`  | `'default'` | Coordinated palette, surfaces, and brand accents  |
...
The `nuxt` preset owns its neutral scale, primary colors, brand surfaces, and light and dark modes. Use the default preset for independent palette selection.
...
| `site.icon`                | `string`                         | `/favicon.svg`                                                                                                          | Browser icon and generated social-image mark     |
| `site.logo.light`          | `string`                         | `/logo.svg`                                                                                                             | Light-mode header logo                           |
...
`nav.socialIcons` renders the configured [social links](#analytics-and-social-links) as quiet icon buttons in the header utility rail. On desktop they sit after theme and language controls; on mobile they stay direct beside search and the menu. When `socialIcons` is `false`, social links stay out of the header and appear as labelled pills in the mobile drawer and text links in the footer. It stays off by default so upgrading never adds links to an existing header.
...
<Api title="ginkoDocs.landing" :groups='[{"label":"Landing","entries":[{"name":"title","annotation":"LocalizedText","required":true,"description":"Hero headline."},{"name":"description","annotation":"LocalizedText","required":true,"description":"Hero paragraph below the title."},{"name":"primary","annotation":"Link","required":true,"description":"Primary hero action with localized `label` and `to`."},{"name":"secondary","annotation":"Link","optional":true,"description":"Optional second hero action."},{"name":"hero.media","annotation":"HeroMedia","optional":true,"description":"Hero image, code panel, or code tabs. The accepted forms are documented in the panel below."},{"name":"install.command","annotation":"string","optional":true,"description":"Copyable install command rendered under the hero actions."},{"name":"features","annotation":"FeatureCard[]","default":"[]","description":"Feature summaries rendered as cards."},{"name":"agent","annotation":"AgentBand","optional":true,"description":"Dark full-width band with localized copy and a terminal transcript."},{"name":"cta","annotation":"ClosingCta","optional":true,"description":"Final call to action; its primary link falls back to `landing.primary`."}]},{"label":"FeatureCard","entries":[{"name":"title","annotation":"LocalizedText","required":true,"description":"Short landing-page claim, not a second documentation index."},{"name":"description","annotation":"LocalizedText","required":true,"description":"One-sentence support for the claim."},{"name":"icon","annotation":"string","optional":true,"description":"Iconify name such as `lucide:braces`."}]},{"label":"AgentBand","entries":[{"name":"title","annotation":"LocalizedText","required":true,"description":"Band headline."},{"name":"description","annotation":"LocalizedText","required":true,"description":"Band paragraph."},{"name":"code","annotation":"string","required":true,"description":"Terminal transcript. Lines beginning with `$` render as commands, lines beginning with `#` as comments."}]},{"label":"ClosingCta","entries":[{"name":"title","annotation":"LocalizedText","required":true,"description":"Closing headline."},{"name":"primary","annotation":"Link","optional":true,"description":"Falls back to `landing.primary` when omitted."},{"name":"secondary","annotation":"Link","optional":true,"description":"Optional second closing action."}]}]' />

Hero media is a union discriminated by `type`; each tab of the panel below documents one accepted form:

<Api title="hero.media" :groups='[{"label":"image","entries":[{"name":"type","annotation":"\"image\"","required":true,"description":"Renders a product screenshot."},{"name":"src","annotation":"string","required":true,"description":"Public path of the image."},{"name":"alt","annotation":"string","required":true,"description":"Alternative text announced by screen readers."}]},{"label":"code","entries":[{"name":"type","annotation":"\"code\"","required":true,"description":"Renders a single highlighted code panel."},{"name":"code","annotation":"string","required":true,"description":"Source text of the panel."},{"name":"language","annotation":"string","optional":true,"description":"Derived from `filename` when omitted."},{"name":"filename","annotation":"string","optional":true,"description":"Caption shown above the panel."},{"name":"layout","annotation":"\"wide\"","optional":true,"description":"Uses spare horizontal space on wide screens."}]},{"label":"code-tabs","entries":[{"name":"type","annotation":"\"code-tabs\"","required":true,"description":"Renders several switchable code examples."},{"name":"tabs","annotation":"Tab[]","required":true,"description":"One entry per example."},{"name":"layout","annotation":"\"wide\"","optional":true,"description":"Uses spare horizontal space on wide screens."},{"name":"tabs[].label","annotation":"LocalizedText","required":true,"description":"Tab label."},{"name":"tabs[].icon","annotation":"string","optional":true,"description":"Iconify name shown before the label."},{"name":"tabs[].filename","annotation":"string","optional":true,"description":"Caption of the tab&#39;s panel."},{"name":"tabs[].language","annotation":"string","optional":true,"description":"Derived from `filename` when omitted."},{"name":"tabs[].code","annotation":"string","required":true,"description":"Source text of the tab&#39;s panel."}]}]' />
