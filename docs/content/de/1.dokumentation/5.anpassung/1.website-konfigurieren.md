...
`site.url` ist die Laufzeitbasis für Canonical-Links und Seitenaktionen. Verwende dieselbe Produktions-URL in App Config, Nuxt Site Config und `i18n.baseUrl`; [SEO und Social Cards]($docs/features/seo-and-social-cards) zeigt die vollständige Verdrahtung.
