...
Setze `layout: 'wide'` für Code- oder Code-Tab-Medien, wenn lange Zeilen mehr Platz brauchen. Das Panel nutzt auf breiten Bildschirmen den freien Platz bis zum Rand des Viewports. Die Textspalte und kleinere Layouts bleiben unverändert.
