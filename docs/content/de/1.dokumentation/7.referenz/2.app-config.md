...
| ------------------ | ------------------------- | ----------- | ------------------------------------------------- |
| `theme.preset`     | `'default' \| 'nuxt'`     | `'default'` | Abgestimmte Palette, Flächen und Markenakzente    |
...
| `theme.codeBlocks` | `'dark' \| 'adaptive'`    | `'dark'`    | Flächen und Syntaxhervorhebung von Codeblöcken    |
...
Das `nuxt`-Preset steuert seine Neutralpalette, Primärfarben, Markenflächen sowie den Light und Dark Mode gemeinsam. Verwende das Standard-Preset für eine unabhängige Palettenauswahl.
...
Syntax-Tokenfarben werden separat zur Build-Zeit konfiguriert; siehe [Den Layer gestalten und überschreiben]($docs/customization/theming-and-overrides).

Codeblöcke bleiben standardmäßig dunkel, auch wenn die Seite den Light Mode verwendet. Setze `codeBlocks: 'adaptive'`, um im Light Mode helle und im Dark Mode dunkle Codeblöcke zu verwenden. Inline-Code folgt immer dem Seitenmodus.
...
| `site.icon`                | `string`                         | `/favicon.svg`                                                                                                          | Browser-Symbol und Marke für generierte Social Images |
| `site.logo.light`          | `string`                         | `/logo.svg`                                                                                                             | Logo für Light Mode                                   |
...
| `site.legalLinks`          | `GinkoDocsLink[]`                | `[]`                                                                                                                    | Rechts- und Unternehmenslinks im Footer               |

Setze eine Produktions-URL. Der lokale Standard würde im Deployment falsche Canonical- und Agent-Links erzeugen.

Konfiguriere die Rechtslinks ausdrücklich, damit jede Site auf den richtigen Rechtsträger verweist:
...
`nav.socialIcons` zeigt die konfigurierten [Social Links](#analytics-und-social-links) als dezente Icon-Buttons in der Utility-Leiste der Kopfzeile. Auf dem Desktop stehen sie hinter Theme- und Sprachsteuerung; mobil bleiben sie direkt neben Suche und Menü erreichbar. Bei `socialIcons: false` erscheinen Social Links nicht in der Kopfzeile, sondern als beschriftete Pills im mobilen Drawer und als Textlinks im Footer. Der Standard ist `false`, damit ein Upgrade keiner bestehenden Kopfzeile Links hinzufügt.
...
<Api title="ginkoDocs.landing" :groups='[{"label":"Landing","entries":[{"name":"title","annotation":"LocalizedText","required":true,"description":"Hero-Überschrift."},{"name":"description","annotation":"LocalizedText","required":true,"description":"Hero-Absatz unter dem Titel."},{"name":"primary","annotation":"Link","required":true,"description":"Primäre Hero-Aktion mit lokalisiertem `label` und `to`."},{"name":"secondary","annotation":"Link","optional":true,"description":"Optionale zweite Hero-Aktion."},{"name":"hero.media","annotation":"HeroMedia","optional":true,"description":"Hero-Bild, Code-Panel oder Code-Tabs. Die akzeptierten Formen dokumentiert das Panel unten."},{"name":"install.command","annotation":"string","optional":true,"description":"Kopierbarer Installationsbefehl unter den Hero-Aktionen."},{"name":"features","annotation":"FeatureCard[]","default":"[]","description":"Feature-Zusammenfassungen als Karten."},{"name":"agent","annotation":"AgentBand","optional":true,"description":"Dunkles Band über die volle Breite mit lokalisiertem Text und einem Terminal-Transcript."},{"name":"cta","annotation":"ClosingCta","optional":true,"description":"Abschließende Aktion; ihr primärer Link fällt auf `landing.primary` zurück."}]},{"label":"FeatureCard","entries":[{"name":"title","annotation":"LocalizedText","required":true,"description":"Kurze Landing-Page-Aussage, kein zweiter Dokumentationsindex."},{"name":"description","annotation":"LocalizedText","required":true,"description":"Ein Satz, der die Aussage stützt."},{"name":"icon","annotation":"string","optional":true,"description":"Iconify-Name wie `lucide:braces`."}]},{"label":"AgentBand","entries":[{"name":"title","annotation":"LocalizedText","required":true,"description":"Überschrift des Bands."},{"name":"description","annotation":"LocalizedText","required":true,"description":"Absatz des Bands."},{"name":"code","annotation":"string","required":true,"description":"Terminal-Transcript. Zeilen mit `$` erscheinen als Befehle, Zeilen mit `#` als Kommentare."}]},{"label":"ClosingCta","entries":[{"name":"title","annotation":"LocalizedText","required":true,"description":"Abschließende Überschrift."},{"name":"primary","annotation":"Link","optional":true,"description":"Fällt auf `landing.primary` zurück, wenn nicht gesetzt."},{"name":"secondary","annotation":"Link","optional":true,"description":"Optionale zweite Abschlussaktion."}]}]' />

Hero-Medien sind eine über `type` unterschiedene Union; jeder Tab des Panels unten dokumentiert eine akzeptierte Form:

<Api title="hero.media" :groups='[{"label":"image","entries":[{"name":"type","annotation":"\"image\"","required":true,"description":"Rendert einen Produkt-Screenshot."},{"name":"src","annotation":"string","required":true,"description":"Öffentlicher Pfad des Bildes."},{"name":"alt","annotation":"string","required":true,"description":"Alternativtext für Screenreader."}]},{"label":"code","entries":[{"name":"type","annotation":"\"code\"","required":true,"description":"Rendert ein einzelnes hervorgehobenes Code-Panel."},{"name":"code","annotation":"string","required":true,"description":"Quelltext des Panels."},{"name":"language","annotation":"string","optional":true,"description":"Wird aus `filename` abgeleitet, wenn nicht gesetzt."},{"name":"filename","annotation":"string","optional":true,"description":"Beschriftung über dem Panel."},{"name":"layout","annotation":"\"wide\"","optional":true,"description":"Nutzt auf breiten Bildschirmen freien horizontalen Platz."}]},{"label":"code-tabs","entries":[{"name":"type","annotation":"\"code-tabs\"","required":true,"description":"Rendert mehrere umschaltbare Code-Beispiele."},{"name":"tabs","annotation":"Tab[]","required":true,"description":"Ein Eintrag pro Beispiel."},{"name":"layout","annotation":"\"wide\"","optional":true,"description":"Nutzt auf breiten Bildschirmen freien horizontalen Platz."},{"name":"tabs[].label","annotation":"LocalizedText","required":true,"description":"Tab-Beschriftung."},{"name":"tabs[].icon","annotation":"string","optional":true,"description":"Iconify-Name vor der Beschriftung."},{"name":"tabs[].filename","annotation":"string","optional":true,"description":"Beschriftung des Tab-Panels."},{"name":"tabs[].language","annotation":"string","optional":true,"description":"Wird aus `filename` abgeleitet, wenn nicht gesetzt."},{"name":"tabs[].code","annotation":"string","required":true,"description":"Quelltext des Tab-Panels."}]}]' />
