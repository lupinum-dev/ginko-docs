...
Syntax-Tokenfarben werden separat zur Build-Zeit konfiguriert; siehe [Den Layer gestalten und überschreiben]($docs/customization/theming-and-overrides#syntaxhervorhebung-wählen).
