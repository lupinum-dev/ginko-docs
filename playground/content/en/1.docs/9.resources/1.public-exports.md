...
| Export                     | Kind           | Purpose                                                                 |
| -------------------------- | -------------- | ----------------------------------------------------------------------- |
| `ginkoDocsComponentTags`   | Runtime object | Maps all 44 authored tag names to Vue component names                   |
...
| `GinkoDocsComponentTag`    | Type           | Union of the 44 authored tag names                                      |
