...
This reference describes `@lupinum/ginko-docs` 0.2.5. Install the layer together with its Ginko Content peer in the consuming Nuxt application.

Ginko Content 0.3.5 resolves application-registered prose components ahead of its bundled defaults; the layer's Markdown image pipeline depends on that resolution order. Earlier Content versions are not supported by this release.
