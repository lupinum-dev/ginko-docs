...
This reference describes `@lupinum/ginko-docs` 0.2.3. Install the layer together with its Ginko Content peer in the consuming Nuxt application.

Ginko Content 0.3.2 preserves the request context used to register nested query and navigation dependencies during Nuxt 4.5 prerendering. Earlier Content versions are not supported by this release.
