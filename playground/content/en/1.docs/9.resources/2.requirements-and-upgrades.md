...
This reference describes `@lupinum/ginko-docs` 0.2.2. Install the layer together with its Ginko Content peer in the consuming Nuxt application.
...
The effective Nuxt range is therefore `>=4.4.7 <5`, even though Ginko Docs itself declares `^4.4.6`. Use a supported Node release from the Ginko Content engine range.
