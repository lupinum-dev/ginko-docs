...
This reference describes `@lupinum/ginko-docs` 0.2.4. Install the layer together with its Ginko Content peer in the consuming Nuxt application.

Ginko Content 0.3.3 supports the current Nuxt 4.5 toolchain and reloads content configuration changes in the development server without a restart. Earlier Content versions are not supported by this release.
